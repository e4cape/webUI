    ...
    >
      <div class="first m-r-10">
        ...
        <el-table
          ...
          @current-change="onLeftSelectionChange"
          class="m-b-10"
          v-loading="fristLoading"
          element-loading-text="拼命加载中"
        >
          <el-table-column
            prop="Title"
        ...
        <div class="myPagination-bar m-t-10">
          ...
          <div class="pagination-controller">
            ...
            <button
              class="next-btn"
              @click="nextPage"
              :disabled="firstPg === pages"
              :class="{'isDisabled': firstPg === pages}"
            >
      ...
      <div class="second m-l-10">
        <el-table
          ...
          v-loading="fristLoading || secondLoading"
          element-loading-text="拼命加载中"
        >
        ...
        <pagination
          ...
          :size="secondSize"
          :total="secondTotal"
          @currentChange="secondCurrentChange"
          @sizeChange="secondSizeChange"
        ></pagination>
      </div>
...
import {
  ...
  COLLEGE_API_SETTINGSOLUTIONITEM_CREATE // 专题管理 - 添加专题
} from '@/apis/science'
...
export default {
  ...
  methods: {
    ...
    getFirstData() {
      ...
      COLLEGE_API_INFRASTSUBJECTBASIC_GETS({
        Title: this.title,
    ...
    getItems() {
      ...
      COLLEGE_API_INFRASTSUBJECTITEM_GETS({
