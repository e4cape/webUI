<template>
  <div class="content">
    <el-form :model="form" name="btnTourListForm" ref="search" class="item-lh-26" @keyup.enter.native="search" :inline="true">
      <el-row type="flex" class="search-box">
        <el-col>
          <el-form-item label="日期：" prop="createTimeRange">
            <el-date-picker
              name="btnTourlistDate"
          ...
          <el-form-item name="btnTourListFirst" prop="CreateTime1" v-show="false">
            <el-input v-model="form.CreateTime1"></el-input>
          </el-form-item>
          <el-form-item name="btnTourListSecond" prop="CreateTime2" v-show="false">
            <el-input v-model="form.CreateTime2"></el-input>
          </el-form-item>
          <el-form-item label="变化类型：" prop="ChangeType">
            <el-select name="btnTourListChageType" v-model="form.ChangeType">
          ...
          <el-form-item label="门店名称：" v-if="characterType == CharacterType.Company">
            <el-select name="btnTourListStoreName" v-model="form.CharacterId">
          ...
          <el-form-item label="贡献人员：" prop="OfferUser">
            <el-input name="btnTourListOfferUser" v-model="form.OfferUser"></el-input>
          </el-form-item>
        </el-col>
        <el-col class="search-btn">
          <el-button type="primary" name="btnTourListSearch" @click="search">搜索</el-button>
          <el-button type="default" name="btnTourListReset" @click="reset">重置</el-button>
        </el-col>
      </el-row>
    </el-form>
    <el-table :data="tableData" v-loading="$store.getters.tb_loading">
      ...
      <el-table-column prop="OfferUser" label="贡献人员" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        CreateTime1: '',
        CreateTime2: '',
        BalanceType: BalanceType.ValidTour,
        ChangeType: 0,
        CharacterId: '',
        OfferUser: '',
        PageIndex: 1,
  ...
  methods: {
    ...
    init() {
      ...
      this.form.OfferUser = query.OfferUser || ''
    ...
    initRoute() {
      this.$router.replace({
        path: '/finance/management/tourlist',
