<template>
  <el-dialog title="修改单位" :visible.sync="visible" custom-class="supplier-dialog">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="单位类型：" prop="PartnerType">
            <el-select disabled filterable v-model="editForm.PartnerType" placeholder="请选择" name="PartnerType">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="结算方式：" prop="SettleType">
            <el-radio-group v-model="editForm.SettleType">
