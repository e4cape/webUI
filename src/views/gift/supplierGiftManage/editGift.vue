  ...
  <div>
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="礼品分类：" prop="categoryId">
        ...
        <span name="btnEdit" @click="isEdit = true" v-if="!isEdit" class="el-button el-button--text el-button--mini">编辑</span>
      </el-form-item>
      ...
      <el-form-item label="商品图片：" prop="imgUrl" :show-message="form.arrayImageUrls.length < 1">
        <div class="clearfix">
          ...
          <div v-if="form.arrayImageUrls.length < 5" class="img-uploader" name="btnIclick" @click="iClick">
    ...
    <div class="dynamic">
      <div>
        <el-input v-model="specificationName" style="width:100px" maxlength="10" placeholder="规格"></el-input>
        <span>:</span>
      </div>
      <div>
        ...
        <el-button name="btnAddDyItem1" type="primary" icon="el-icon-plus" circle @click="addDynamicItem(1)"></el-button>
      </div>
    </div>
    <div class="dynamic">
      <div>
      ...
      <div>
        <div v-for="(item,index) in styleList" :key="index">
          ...
          <el-button name="btnDeleteStyleListVal" type="danger" icon="el-icon-delete" circle @click="deleteDynamicItem(index,2)" v-if="styleList.length > 1"></el-button>
        </div>
        <el-button name="btnAddDyItem2" type="primary" icon="el-icon-plus" circle @click="addDynamicItem(2)"></el-button>
      </div>
    </div>
    <div class="title">
      <h3>规格参数</h3>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-input v-model="scope.row.name" style="width:160px" maxlength="20"></el-input>            
          </template>
        </el-table-column>
        <el-table-column
          prop="val"
        ...
        <el-table-column
          ...
          width="80">
          <template slot-scope="scope">
            <span name="btnDeleteParamterVal" class="el-button el-button--text el-button--mini"  @click="deleteParameterList(scope.$index)">删除</span>
          </template>
        </el-table-column>
      </el-table>
    </el-form>
    <span name="btnAddParamterVal" class="el-button el-button--text el-button--mini p-10" @click="addParameterList">添加参数</span>
    <div class="title">
      <h3>商品详情</h3>
    </div>
    <div>
...
import {
  ...
  GIFTING_API_GIFT_SAVEUPDATEBYSUPPLIER,
  GIFTING_API_GIFT_GETBYIDBYSUPPLIER,
} from '@/apis/gifting'
import {
  ImageUploadPaths, BrandStatus
} from '@/enums/gifting'
export default {
  data() {
  ...
  methods: {
    init(){
      !this.$route.query.giftId && this.$router.back(-1)
      GIFTING_API_GIFT_GETBYIDBYSUPPLIER(this.$route.query.giftId).then(res=>{
    ...
    submit(submitType){
      this.$refs['form'].validate((valid) => {
        ...
        GIFTING_API_GIFT_SAVEUPDATEBYSUPPLIER(params).then(res => {
          if(res.data.Code === 'CORRECT'){
