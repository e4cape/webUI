    ...
    <el-form :model="queryForm">
      <el-row :gutter="2">
        <el-col :span="3">
          <el-form-item>
            <el-select
              v-model="queryForm.StockCompareType"
              @change="search"
              filterable
            ...
            >
              ...
              <el-option
                v-for="(item,index) in StockCompareType.Types"
                :key="index"
                :label="item"
        ...
        <el-col :span="3">
          <el-form-item>
            ...
            >
              ...
              <el-option
                v-for="(item,index) in FinanceType.Types"
                :key="index"
                :label="item"
                :value="parseInt(index)"
              ></el-option>
        ...
        <el-col :span="3">
          <el-form-item>
            ...
            >
              ...
              <el-option
                v-for="(item,index) in $store.getters.materialType.Types"
                :key="index"
                :label="item"
                :value="parseInt(index)"
              ></el-option>
        ...
        <el-col :span="3">
          <el-form-item>
            ...
            >
              ...
              <el-option
                v-for="(item,index) in $store.getters.categoryType.Types"
                :key="index"
                :label="item"
                :value="parseInt(index)"
              ></el-option>
        ...
        <el-col :span="3">
          <el-form-item>
            <el-select v-model="queryForm.GoldType" @change="search" filterable name="goldType">
              ...
              <el-option
                v-for="(item,index) in $store.getters.goldType.Types"
                :key="index"
                :label="item"
                :value="parseInt(index)"
              ></el-option>
        ...
        <el-col :span="3">
          <el-form-item>
            <el-select v-model="queryForm.GoodsType" @change="search" filterable name="goodsType">
              ...
              <el-option
                v-for="(item,index) in GoodsType.Types"
                :key="index"
                :label="item"
                :value="parseInt(index)"
              ></el-option>
...
import { STOCKING_API_GOODS_STOCK_WAREHOUSE_GETS } from '@/apis/stocking.js'
  ...
  methods: {
    ...
    addGoods(flag) {
      if (!this.selectData.length) {
        ...
        this.$emit('listenAddGoods', result, flag)
    ...
    getData() {
      ...
      STOCKING_API_GOODS_STOCK_WAREHOUSE_GETS(this.queryForm).then(res => {
