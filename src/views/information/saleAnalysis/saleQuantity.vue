      ...
      <el-col :span="8">
        ...
        <template>
          <el-table :data="materialData">
            ...
            <el-table-column show-overflow-tooltip prop="Quantity" label="销量"></el-table-column>
            <el-table-column show-overflow-tooltip label="占比">
              <template slot-scope="scope">
                <span style="margin-left: 5px">{{ scope.row.PerQuantity | absolutely}}</span>
              </template>
            </el-table-column>
          </el-table>
        </template>
      ...
      <el-col :span="8">
        ...
        <template>
          <el-table :data="categoryData">
            ...
            <el-table-column show-overflow-tooltip prop="Quantity" label="销量"></el-table-column>
            <el-table-column show-overflow-tooltip prop="PerQuantity" label="占比">
              <template slot-scope="scope">
                <span style="margin-left: 5px">{{ scope.row.PerQuantity | absolutely}}</span>
              </template>
            </el-table-column>
      ...
      <el-col :span="8">
        ...
        <template>
          <el-table :data="goldData">
            ...
            <el-table-column show-overflow-tooltip prop="Quantity" label="销量"></el-table-column>
            <el-table-column show-overflow-tooltip prop="PerQuantity" label="占比" min-width="">
              <template slot-scope="scope">
                <span style="margin-left: 5px">{{ scope.row.PerQuantity | absolutely}}</span>
              </template>
            </el-table-column>
  ...
  methods: {
    ...
    initPiedata(result, data) {
      ...
      if (result.Quantity === 0) {
        ...
        pieData.title.text = '总销量'
      }
      pieData.title.subtext = result.Quantity
      return pieData
    },
    queryChange() {
      let parameter = {
