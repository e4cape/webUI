<template>
  <!-- @module Dialog·取消审核 -->
  <el-dialog title="取消审核" :visible="visible" @update:visible="$emit('update:visible', $event)" @open="cancelReason = ''">
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="primary" @click="cancel" :loading="$store.getters.is_loading" name="btnCancel">确 定</el-button>
...
<script>
import { STOCKING_API_HALF_COUNT_REPORT_BASIC_CANCEL2 } from '@/apis/stocking.js'
...
export default {
  ...
  methods: {
    cancel() {
      ...
      STOCKING_API_HALF_COUNT_REPORT_BASIC_CANCEL2({
