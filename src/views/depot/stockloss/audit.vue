...
import {
  STOCKING_API_STUFF_COUNT_REPORT_BASIC_AUDIT,
  STOCKING_API_STUFF_COUNT_REPORT_BASIC_REJECT,
  ...
  methods: {
    auditAdjust() {
      ...
      if (this.auditType === this.YNStatus.No) {
        apiMethod = STOCKING_API_STUFF_COUNT_REPORT_BASIC_REJECT
      }else{
        apiMethod = STOCKING_API_STUFF_COUNT_REPORT_BASIC_AUDIT
      }
