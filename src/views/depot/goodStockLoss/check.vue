  ...
  <div class="content">
    ...
    <div class="buttons">
      <template v-if="detail.State === GoodsCountReportBasicState.Reject || detail.State === GoodsCountReportBasicState.Draft">
        <router-link :to="{path: '/depot/goodstockloss/edit',query:{id:detail.ReportId}}" name="btnEdit">
    ...
    <!-- end 货品详情-->
    <print-order :visible.sync="printDialog" :conditions="encodeURIComponent(JSON.stringify({OrderId: detail.ReportId }))" :printingType="SettingPrintingType.StockingCloudGoodsCountReportBasic1"></print-order>
  </div>
</template>
