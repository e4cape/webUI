...
<script>
import { STOCKING_API_WEIW_STUFF_SETTLE_BASIC_ABANDON } from '@/apis/stocking.js'
export default {
  ...
  methods: {
    makeAbandon () {
      ...
      STOCKING_API_WEIW_STUFF_SETTLE_BASIC_ABANDON({
        SettleId: Number(this.data[0].SettleId)||0,
