<template>
  <div class="content">
    <div class="panel">
      <div class="panel-hd">
        <span class="title">查看报溢单({{StuffType.Types[$route.query.StuffType]}})</span>
    ...
    <div class="buttons">
      <template v-if="detail.State == stuffCountReportBasicState.Reject || detail.State == stuffCountReportBasicState.Draft">
        <router-link :to="{path:'/depot/stockover/edit',query:{id:detail.ReportId, StuffType:$route.query.StuffType}}" name="btnEdit">
