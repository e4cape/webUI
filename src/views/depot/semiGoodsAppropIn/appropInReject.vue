...
<script>
import {
  STOCKING_API_HALF_ALLOT_ORDER_INTAKE_REJECTS,
  STOCKING_API_HALF_ALLOT_ORDER_INTAKE_REJECT
  ...
  methods: {
    makeReject() {
      ...
      if (this.data.length > 1) {
        result = STOCKING_API_HALF_ALLOT_ORDER_INTAKE_REJECTS({
        ...
        result = STOCKING_API_HALF_ALLOT_ORDER_INTAKE_REJECT({
