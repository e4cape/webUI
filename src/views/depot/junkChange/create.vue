<template>
  <div>
    <el-dialog title="选择旧货" :visible.sync="visible">
      <div class="cj_head">
        <el-row :gutter="2">
          <el-col :span="4">
...
export default {
  // props: ['selectDialog', 'data', 'KindTypeEk'],
  props: {
    selectDialog: {
      default: false,
      type: Boolean
  ...
  methods: {
    ...
    selectAddJunk() {
      ...
      this.$router.push({
        path: '/depot/junkChange/add',
        query: {
          id: this.selections[0].GoodsId,
          ChangeId: this.$route.query.id,
          JunkId: this.selections[0].JunkId,
          // id: this.$route.query.id,
          ItemId: this.selections[0].ItemId,
          // orderType: 1,
