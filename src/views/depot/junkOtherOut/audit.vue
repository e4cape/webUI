...
<script>
import {
  STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_REJECT,
  STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_AUDIT,
  STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_REJECTS,
  STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_AUDITS
    ...
    auditReturn() {
      ...
      if(this.isOne){
        if (this.auditType === this.YNStatus.No) {
          apiMethod = STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_REJECT
        }else{
          apiMethod = STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_AUDIT
        }
      }else{
        if (this.auditType === this.YNStatus.No) {
          apiMethod = STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_REJECTS
        }else{
          apiMethod = STOCKING_API_JUNK_OUTAKE_ORDER_BASIC_AUDITS
        }
      }
