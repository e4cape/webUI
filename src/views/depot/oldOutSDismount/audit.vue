...
import {
  STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_AUDITS2,
  STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_AUDIT2,
  STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_REJECTS2,
  STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_REJECT2
    ...
    auditAdjust() {
      ...
      if(this.isOne){
        if (this.auditType === this.YNStatus.No) {
          apiMethod = STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_REJECT2
        }else{
          apiMethod = STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_AUDIT2 
        }
      }else{
        if (this.auditType === this.YNStatus.No) {
          apiMethod = STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_REJECTS2
        }else{
          apiMethod = STOCKING_API_WEIW_GJUNK_SPLIT_BASIC_AUDITS2 
        }
      }
