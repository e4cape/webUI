...
import {
  STOCKING_API_HALF_COUNT_REPORT_BASIC_AUDITS,
  STOCKING_API_HALF_COUNT_REPORT_BASIC_AUDIT,
  STOCKING_API_HALF_COUNT_REPORT_BASIC_REJECTS,
  STOCKING_API_HALF_COUNT_REPORT_BASIC_REJECT
  ...
  methods: {
    ...
    audit() {
      ...
      if (this.data.length > 1) {
        ...
        result =
          this.auditType === YNStatus.Yes
            ? STOCKING_API_HALF_COUNT_REPORT_BASIC_AUDITS(param)
            : STOCKING_API_HALF_COUNT_REPORT_BASIC_REJECTS(param)
      } else {
        let param = {
          CheckNote: this.auditReason,
        ...
        result =
          this.auditType === YNStatus.Yes
            ? STOCKING_API_HALF_COUNT_REPORT_BASIC_AUDIT(param)
            : STOCKING_API_HALF_COUNT_REPORT_BASIC_REJECT(param)
      }
