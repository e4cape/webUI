<template>
  ...
  >
    ...
    <div v-show="!opened">
      <h2 class="header-warning">您尚未开启赠送规则！ 开启后可以为每种材质设置不同的赠送规则。</h2>
    </div>
          ...
          <div>
            ...
            >
              <span class="add-action">
                ...
                <span @click="addDateRule">添加规则</span>
              </span>
