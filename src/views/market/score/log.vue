<template>
  <div class="content">
    <el-form :model="queryForm" ref="search" lable-width="120px" class="item-lh-26" :inline="true">
      <search-panel @onSearch="onSearch" @onReset="onReset">
        ...
        <template slot="seniorSearch">
          ...
          <el-form-item label="赠送数量:">
            <el-col :span="11">
              <el-form-item prop="giveAmtMin" class="inline no-margin">
                <el-input name="inputGiveAmtMin" v-model="queryForm.giveAmtMin" :maxlength="9" @keyup.enter.native="onSearch"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-form-item label="门店:" prop="characterId" v-if="isOneNumberManyShopCompany">
            <el-select name="selectCharacterId" v-model="queryForm.characterId">
    ...
    <el-table :data="data" @sort-change="sortChange" v-loading="$store.getters.tb_loading" element-loading-text="拼命加载中">
      ...
      <el-table-column prop="createTime" label="赠送时间" min-width="160" sortable="custom" show-overflow-tooltip fixed="left">
      ...
      <el-table-column prop="trueName" label="会员名称" min-width="80" show-overflow-tooltip></el-table-column>
