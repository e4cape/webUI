        ...
        >
          ...
          >
            <div class="date-item">
              ...
              >固定日期</el-radio>
              <el-date-picker
                name="datePickerFixedDate"
                style="margin-left: 10px;"
                v-model="model.fixedDate"
                type="date"
                placeholder="选择日期"
        ...
        <el-form-item label="赠送倍率">
          <div class="giving-options">
            ...
            <el-form-item prop="scoreRate">
              <el-input-number
                name="inputNumberScoreRate"
                :min="0"
                :controls="null"
                v-model="model.scoreRate"
              ></el-input-number>
            </el-form-item>倍赠送,
            礼金按
            <el-form-item prop="goldenRiceRate">
              <el-input-number
                name="inputNumberGoldenRiceRate"
                :min="0"
                :controls="null"
                v-model="model.goldenRiceRate"
              ></el-input-number>
            </el-form-item>倍赠送,
          </div>
        </el-form-item>
