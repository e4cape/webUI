  ...
  var arrDbClick = {
    ...
    Xheditor = function (textarea, options) {
      ...
      this.init = function () {
          ...
          if (j)
            if (is(j, "array"))
              for (var k in j) headHTML += '<link rel="stylesheet" href="' + j[k] + '"/>';
              ...
              if (d && (c = d.files) && c.length > 0) {
                ...
                return 0 === i.length ? !1 : (g = i.join(","), f = b(c), 1 === f ? alert(getLang("upload.extLimit", g.replace(/\w+:,/g, ""))) : 2 === f ? alert(getLang("upload.typeLimit")) : f && _this.startUpload(c, settings["up" + f + "Url"], "*", function (a) {
                  var b, c = [],
                    d = settings.onUpload;
                  d && d(a);
                  for (var e = 0, g = a.length; g > e; e++) b = a[e],
        ...
        this.cleanWord = function (a) {
          ...
          if (c > 0 && 3 > c && /mso(-|normal)|WordDocument|<table\s+[^>]*?x:str|\s+class\s*=\s*"?xl[67]\d"/i.test(a)) {
            a = a.replace(/<!--[\s\S]*?-->|<!(--)?\[[\s\S]+?\](--)?>|<style(\s+[^>]*?)?>[\s\S]*?<\/style>/gi, ""),
              a = a.replace(/\r?\n/gi, ""),
              isIE ? (a = a.replace(/<v:shapetype(\s+[^>]*)?>[\s\S]*<\/v:shapetype>/gi, ""), a = a.replace(/<v:shape(\s+[^>]+)?>[\s\S]*?<v:imagedata(\s+[^>]+)?>\s*<\/v:imagedata>[\s\S]*?<\/v:shape>/gi, function (a, b, c) {
                var d;
        ...
        this.formatXHTML = function (a, b) {
          ...
          for (var x, y, z, A, B, C, D, E = 0, F = -1, G = "body", H = !1; x = t.exec(a);) y = x.index,
        ...
        this.toggleSource = function (a) {
          if (bSource !== a) {
            ...
            if (bSource ? (b = _this.getSource(), e.html("").removeAttr("scroll").attr("class", "editMode" + bodyClass), isIE ? d.contentEditable = "true" : _doc.designMode = "On", isMozilla && (_this._exec("inserthtml", "-"), $("#" + idFixFFCursor).show().focus().hide()), h = "Source") : (_this.pasteHTML(f, !0), b = _this.getSource(!0), g = b.indexOf(f), isOpera || (g = b.substring(0, g).replace(/\r/g, "").length), b = b.replace(/(\r?\n\s*|)<span id="_xhe_cursor"><\/span>(\s*\r?\n|)/, function (a, b, c) {
                return b && c ? "\r\n" : b + c
              }), isIE ? d.contentEditable = "false" : _doc.designMode = "Off", e.attr("scroll", "no").attr("class", "sourceMode").html('<textarea id="sourceCode" wrap="soft" spellcheck="false" style="width:100%;height:100%" />'), c = $("#sourceCode", e).blur(_this.getSource)[0], h = "WYSIWYG"), bSource = !bSource, _this.setSource(b), _this.focus(), bSource)
              if (c.setSelectionRange) c.setSelectionRange(g, g);
              else {
              ...
              if (("" === a || 0 === f.length) && _this._exec("unlink"), "" !== a && "http://" !== a) {
                ...
                if (b.length > 1) {
                  ...
                  "" !== c && (j += ' target="' + c + '"'),
                    j += ">xhe_tmptext</a>",
                    d = "" !== k ? k : d ? d : a;
                  for (var m = 0, n = b.length; n > m; m++) a = b[m],
        ...
        this.startUpload = function (fromFiles, toUrl, limitExt, onUploadComplete) {
          function onUploadCallback(sText, bFinish) {
            ...
            return data.err == '' || data.msg == '' ? alert(getLang("upload.apiError", toUrl, sText)) : data.err ? alert(data.err) : (arrMsg.push(data.msg), bOK = !0),
          ...
          function f(b, c, d, e) {
            ...
            h = new XMLHttpRequest,
              ...
              h.onreadystatechange = function () {
                if (4 === h.readyState) {
                  var result = JSON.parse(h.responseText)
                  if (result.Code == "CORRECT") {
                    d(JSON.stringify({
                      err: result.Message,
                      msg: {
                        url: result.Data.Host + result.Data.Path[0]
                      }
                    }))
                  } else {
                    d(JSON.stringify({
    ...
    $.fn.xheditor = function (options) {
      ...
      return this.each(function () {
          if ($.nodeName(this, "TEXTAREA"))
            if (options === !1) this.xheditor && (this.xheditor.remove(), this.xheditor = null);
